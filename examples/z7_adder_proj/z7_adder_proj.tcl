...
#
# z7_adder_proj.tcl: Tcl script for re-creating project 'z7_adder_proj'
#
# Generated by Vivado on Fri Aug 08 15:25:26 +0200 2025
...
#
# 1. This project restoration tcl script (z7_adder_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "z7_adder_proj/z7_adder_proj.srcs/utils_1/imports/synth_1/z7_adder_design_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../z7_adder_proj/z7_adder_proj.srcs/utils_1/imports/synth_1/z7_adder_design_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "z7_adder_proj"
...
set script_file "z7_adder_proj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../z7_adder_proj"]"
...
set_property -name "board_part_repo_paths" -value "C:/Users/karol/AppData/Roaming/Xilinx/Vivado/2025.1/xhub/board_store/xilinx_board_store" -objects $obj
set_property -name "board_part" -value "microphase:z7-nano-7020:part0:1.0" -objects $obj
...
set_property -name "platform.board_id" -value "z7-nano-7020" -objects $obj
...
set_property -name "top" -value "z7_adder_design_wrapper" -objects $obj
...
set file "synth_1/z7_adder_design_wrapper.dcp"
...
# Proc to create BD z7_adder_design
proc cr_bd_z7_adder_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name z7_adder_design
...
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO} \
...
\
  ...
  set adder_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:adder_ip:1.0 adder_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins adder_ip_0/s_axi_control]
  ...
  [get_bd_pins adder_ip_0/ap_rst_n] \
  [get_bd_pins axi_smc/aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs adder_ip_0/s_axi_control/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-307,-50",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1110 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1110 -y 330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 250 -y 380 -defaultsOSRD
preplace inst adder_ip_0 -pg 1 -lvl 3 -x 940 -y 230 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 640 -y 210 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 250 -y 100 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 200 480 290 780J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 210 470
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 500 300 790J
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 490 190n
preplace netloc axi_smc_M00_AXI 1 2 1 N 210
...
levelinfo -pg 1 0 250 640 940 1110
pagesize -pg 1 -db -bbox -sgen 0 0 1230 550
"
}
...
# End of cr_bd_z7_adder_design()

cr_bd_z7_adder_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files z7_adder_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files z7_adder_design.bd ] 
set_property IS_ENABLED "1" [get_files z7_adder_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files z7_adder_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files z7_adder_design.bd ] 
set_property PFM_NAME "" [get_files z7_adder_design.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files z7_adder_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files z7_adder_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files z7_adder_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files z7_adder_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files z7_adder_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files z7_adder_design.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list z7_adder_design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../z7_adder_proj/z7_adder_proj.gen/sources_1/bd/z7_adder_design/hdl/z7_adder_design_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list z7_adder_design.bd]] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/z7_adder_design_wrapper.dcp" -objects $obj
